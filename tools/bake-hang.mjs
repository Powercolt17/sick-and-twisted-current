...
while(rows.length<12000){const f=hangFeature(seed++);if(f)rows.push([f.seed,f.cents,f.locks,f.upgrades,f.first,f.retriggers,f.tumbleEvents,f.spins.length,f.stampUpgrades,f.temporarySpins]);}
