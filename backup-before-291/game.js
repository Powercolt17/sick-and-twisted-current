...
const BASE_SOUND_KEYS=['vault','ropeBurn','ropeFizzle','spin','scatter','scatterB','click','multi','lanternIgnite','stop0','stop1','stop2','stop3','stop4','stop5'];
