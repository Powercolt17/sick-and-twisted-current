...
//   Hang 'Em High, All In Spins -> bloody rope frame (animated crow + dripping blood)
//   Hell To Pay -> OpenArt hell frame, keyed from green (RGB|matte packed H.264)
//   Base, Bounty Booster, Trickster Spins and Blood Money keep the original reel-frame.js border.
...
export function featureBorderKind({mode='normal',bonus=false,label='',feature=null}={}){
 ...
 // All In Spins use the bloody rope border; base, Bounty Booster and Trickster Spins keep the normal one.
 return mode==='allin'?'rope':'normal';
}
