...
export function createBloodPromotion({stage,reduced=false,onCue=()=>{},onStart=()=>{}}){
 ...
 return {root,update,
  start(){active=true;shownMultiplier=1;event=null;ageNow=null;root.hidden=false;panel.hidden=true;dim.hidden=true;target.reset();lastLevel=-1;setLevel(1);target.announce();measure();},
  ...
  stop(){active=false;event=null;ageNow=null;root.hidden=true;panel.hidden=true;dim.hidden=true;target.reset();delete root.dataset.rewardLevel;},
